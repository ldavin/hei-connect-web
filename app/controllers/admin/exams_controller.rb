class Admin::ExamsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @exam.save
        format.html { redirect_to admin_exam_url(@exam), notice: 'Exam was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @exam.update_attributes(params[:exam])
        format.html { redirect_to admin_exam_url(@exam), notice: 'Exam was successfully updated.' }
